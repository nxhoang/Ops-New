...
(function () {
	...
	DayPilot.gs = function (el, $Z) {
		var x = el;
		if (x.currentStyle)
			var y = x.currentStyle[$Z];
		else if (window.getComputedStyle)
			var y = document.defaultView.getComputedStyle(x, null).getPropertyValue($Z);
	...
	DayPilot.Event = function ($0V, $R, $11) {
		...
		var $12 = {};
		var $13 = ["id", "text", "start", "end", "resource"];
		this.isEvent = true;
		this.temp = function () {
			if ($12.dirty) {
				return $12;
...
(function () {
	...
	DayPilot.Calendar = function (id, $a) {
		...
		this.dispose = function () {
			...
			if (c.nav.header)
				c.nav.header.oncontextmenu = null;
			if (c.nav.corner)
				c.nav.corner.oncontextmenu = null;
		...
		this.$5n = function ($E) {
			...
			if (!$0Z)
				$0Z = DayPilot.gs($E, 'font-family');
			$0Y.style.fontFamily = $0Z;
			var $10 = DayPilot.gs($E, 'fontSize');
			if (!$10)
				$10 = DayPilot.gs($E, 'font-size');
...
(function () {
	...
	DayPilot.Modal = function () {
		...
		this.update = function () {
			...
			this.hideDiv.style.display = ''; /* :::Thomas: Disable to Disallow click on the background to close::: window.setTimeout(function () { $f.hideDiv.onclick = function () { $f.hide(); }; }, 500);*/ this.div.className = this.className;
	...
	DayPilot.Scheduler = function (id, $d) {
		...
		this.$7l = function ($f, $g) {
			...
			if ($f.UpdateType === "Full") {
				...
				if (typeof $f.RowHeaderColumns !== 'undefined')
				...
				if (typeof $f.DynamicLoading !== 'undefined')
					$e.dynamicLoading = $f.DynamicLoading;
				if (typeof $f.TreeEnabled !== 'undefined')
					$e.treeEnabled = $f.TreeEnabled;
				...
				if (typeof $f.TimeZone !== 'undefined')
				...
				if (typeof $f.DurationBarMode !== "undefined")
					$e.durationBarMode = $f.DurationBarMode;
		...
		this.message = function ($V, $W, $X, $Y) {
			...
			if (!this.nav.message) {
				...
				$P.className = "DayPilotMessageBar";
