...
(() => {
    ...
    document.getElementById("aExpandField").addEventListener("click", toggleField);
})();
//#endregion

//#region Functions
function toggleField() {
    $(`#spExpandField`).toggleClass("glyphicon glyphicon-chevron-right glyphicon glyphicon-chevron-down");
}
