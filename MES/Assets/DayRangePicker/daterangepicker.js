...
(function (root, factory) {
    ...
    var DateRangePicker = function(element, options, cb) {
		...
		if (typeof options.template !== 'string' && !(options.template instanceof $))
			/**
			 * by Thomas Lee : 2017-12-01
			 * replace  fa fa-calendar glyphicons glyphicons-calendar
			 * with fa fa-calendar zmdi zmdi-calendar
			 */  
            options.template = '<div class="daterangepicker dropdown-menu">' +
                '<div class="calendar left">' +
                    '<div class="daterangepicker_input">' +
                      '<input class="input-mini form-control" type="text" name="daterangepicker_start" value="" />' +
                      '<i class="fa fa-calendar zmdi zmdi-calendar"></i>' +
                      '<div class="calendar-time">' +
                        '<div></div>' +
                        '<i class="fa fa-clock-o zmdi zmdi-time"></i>' +
                      '</div>' +
                    '</div>' +
    ...
    DateRangePicker.prototype = {
        ...
        renderCalendar: function(side) {
			...
			/* by Thomas Lee, replace icon with zmdi */
			arrow = this.locale.direction == 'ltr' ? { left: 'long-arrow-left', right: 'long-arrow-right' } : { left: 'long-arrow-right', right: 'long-arrow-left'};
		...
		/*by Thomas Lee- Reference URL: https://github.com/dangrossman/bootstrap-daterangepicker/issues/1185 */
