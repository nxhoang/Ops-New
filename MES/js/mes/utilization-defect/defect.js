...
function displayListMesPackage(res) {
    ...
    let factoryVal = $("#selFactory option:selected").val();
    let plnStartDate = $("#beginDate").val();
...
function displayEfficiency(arr) {
    var info = document.getElementById("info-detail-chart");
    info.innerHTML = "";
    ...
    arr.forEach(function (item, idx) {
        ...
        _cell1.classList.add("right");
        if (item.MaxPowerTime == 0 || item.MaxActTime == 0) {
            _cell1.innerHTML = '0%';
        } else {
            _cell1.innerHTML = (item.MaxActTime * 100 / item.MaxPowerTime).toFixed(2) + '%';
        }
        ...
        if (qty == 0) {
            ...
            _cell2.innerHTML = (item.MaxActTime / qty).toFixed(0);
        }
...
//get defect of package
function GetDetailMxPackage(mxpackage) {

    axios.get('../UtilizationDefect/GetDefectTreeMXPackage', {
        params: {
            mxpackage: mxpackage
        }
    })
        .then(function (response) {
            ...
            var info = document.getElementById("info-defect");
            info.innerHTML = "";

            var tbl = document.createElement("TABLE");
            tbl.setAttribute("id", "table-info-defect");
            info.appendChild(tbl);

            var table = document.getElementById("table-info-defect");
            var row0 = table.insertRow(0);
            row0.id = 'title';
            var row1 = table.insertRow(1);
            row1.id = 'row-value';
            ...
            cell0.innerHTML = "Package";
            cell1.innerHTML = "AO No";
            cell2.innerHTML = "Style";
            cell3.innerHTML = "Buyer Style";
            cell4.innerHTML = "Color";
            cell5.innerHTML = "Rev";
            cell6.innerHTML = "Buyer";
            cell7.innerHTML = "Line";
            cell8.innerHTML = "Target";
            cell9.innerHTML = "Total defect";

            var cell1_0 = row1.insertCell(0);
            var cell1_1 = row1.insertCell(1);
            var cell1_2 = row1.insertCell(2);
            var cell1_3 = row1.insertCell(3);
            var cell1_4 = row1.insertCell(4);
            cell1_4.classList = 'right';
            var cell1_5 = row1.insertCell(5);
            cell1_5.classList = 'right';
            var cell1_6 = row1.insertCell(6);
            var cell1_7 = row1.insertCell(7);
            var cell1_8 = row1.insertCell(8);
            cell1_8.classList = 'right';
            var cell1_9 = row1.insertCell(9);
            cell1_9.classList = 'right';
            cell1_0.innerHTML = data.MXPACKAGE;
            cell1_1.innerHTML = data.AONO;
            cell1_2.innerHTML = data.STYLETEXT;
            cell1_3.innerHTML = data.BUYERSTYLETEXT;
            cell1_4.innerHTML = data.StyleColorSerial;
            cell1_5.innerHTML = data.RevNo;
            cell1_6.innerHTML = data.BUYER;
            cell1_7.innerHTML = data.LINENAME;
            cell1_8.innerHTML = data.MXTARGET;
            cell1_9.innerHTML = data.TOTAL_DEFECT;
...
//auto draw chart after 5 minutes
window.setInterval(function () {
    /// call your function here
    if (package_5.length > 0) {
        getDataToDisplayChart(package_5);
        GetDetailMxPackage(package_5);
    }
