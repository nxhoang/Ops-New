...
function loadChart(list, mesPackage, plnStartDate) {
    ...
    try {
        list.forEach(function (item) {
            ...
            time.EmployeeName = item.EmployeeName,
                time.CorporationCode = item.CorporationCode,
                time.ImageName = item.ImageName
            ...
            tooltips: {
                ...
                custom: function (tooltipModel) {
                    ...
                    if (tooltipModel.body) {
                        ...
                        //urlIamge = 'http://' + '118.69.83.197:8011/FileServer/Photos/10108192.jpg';
                        ...
                        //if (urlIamge.length > 0) {
                        //    innerHtml += `<tr><td colspan="2" style="text-align: center;"> <img src="` + urlIamge + `" /> </td></tr>`;
                        //    innerHtml += `<tr><td colspan="2" style="text-align: center;"> ${EmployeeName} </td> </tr>`;
                        //}
                    ...
                    title: function (tooltipItem, data) {
                        listTime.map((item) => {
                            if (item.OpName == tooltipsLabel[tooltipItem[0].index]) {
                                ...
                                //if (item.CorporationCode == '1002' && item.ImageName) {
                                //    urlIamge = 'http://mespk2.pungkookvn.com/HRMAssets/' + item.CorporationCode + '/' + item.ImageName;
                                //} else if (item.CorporationCode == '1006' && item.ImageName) {
                                //    urlIamge = 'http://mespk3.pungkookvn.com/HRMAssets/' + item.CorporationCode + '/' + item.ImageName;
                                //} else if (item.CorporationCode == '1008' && item.ImageName) {
                                //    urlIamge = 'http://mespkbt.pungkookvn.com/HRMAssets/' + item.CorporationCode + '/' + item.ImageName;
                                //} else if (item.CorporationCode == '1009' && item.ImageName) {
                                //    urlIamge = 'http://mespkmt.pungkookvn.com/HRMAssets/' + item.CorporationCode + '/' + item.ImageName;
                                //} else {
                                //    urlIamge = '';
                                //}
                            }
...
function displayEfficiency(arr) {
    ...
    arr.forEach(function (item, idx) {
        ...
        _cell3.classList.add("center");

        var src = '';
        if (item.CorporationCode == '1002' && item.ImageName) {
            src = 'http://mespk2.pungkookvn.com/HRMAssets/' + item.CorporationCode + '/' + item.ImageName;
            _cell3.innerHTML = ` <img src="${src}" /> <br/> <br/> ${item.EmployeeName}`
        } else if (item.CorporationCode == '1006' && item.ImageName) {
            src = 'http://mespk3.pungkookvn.com/HRMAssets/' + item.CorporationCode + '/' + item.ImageName;
            _cell3.innerHTML = ` <img src="${src}" /> <br/> <br/> ${item.EmployeeName}`
        } else if (item.CorporationCode == '1008' && item.ImageName) {
            src = 'http://mespkbt.pungkookvn.com/HRMAssets/' + item.CorporationCode + '/' + item.ImageName;
            _cell3.innerHTML = ` <img src="${src}" /> <br/> <br/> ${item.EmployeeName}`
        } else if (item.CorporationCode == '1009' && item.ImageName) {
            src = 'http://mespkmt.pungkookvn.com/HRMAssets/' + item.CorporationCode + '/' + item.ImageName;
            _cell3.innerHTML = ` <img src="${src}" /> <br/> <br/> ${item.EmployeeName}`
        } else {
            _cell3.innerHTML = '';
        }
