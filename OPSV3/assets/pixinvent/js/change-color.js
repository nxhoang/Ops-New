...
//var _listSideBarBackgroundColor_name = ['aqua-marine', 'sublime-vivid', 'crystal-clear', 'timber', 'black', 'white', 'primary','danger'];
...
/*function setBackgroundColor_LayoutPage(objColor) {
    ...
    localStorage.setItem('bgColorLayout', objColor.BgImage);
}
...
function setBackgroundJsPlum(objColor) {
    ...
    // Oanh add 23Jan2021
    //var setObject = { BgImage: 'linear-gradient(45deg, #1488CC, #2B32B2)', FontColor: '#ffffff' };
    //if (objColor.BgImage == null && objColor.BgImage  == "undefined") {
    //    //if obj null define and Put the object into storage
    //    objColor.BgImage = setObject.BgImage;
    //    objColor.FontColor = setObject.FontColor;

    //    console.log(objColor.BgImage);

    //}
    //end Oanh add 23Jan2021
...
function sideBarSelection() {
    ...
    $('#cl-aqua-marine').click(() => {
        ...
        //setBackgroundColor_LayoutPage(_listSideBarBackgroundColor.gradient_aqua_marine);
    });
    $('#cl-sublime-vivid').click(() => {
        setBackgroundColorBySideBar(_listSideBarBackgroundColor.gradient_sublime_vivid);
        setOnlyBackgroundTitle('sublime-vivid');
        //setBackgroundColor_LayoutPage(_listSideBarBackgroundColor.gradient_sublime_vivid);
    });
    $('#cl-default').click(() => {
...
function ChangeColor() {
    ...
    var default_bg_color = $('.app-sidebar').attr('data-background-color'),
    ...
    if (typeof (Storage) !== "undefined") {
        if (localStorage.lc_bg_Image || localStorage.lc_bg_Color) {
            ...
            //$('.ui-jqgrid-view > .ui-jqgrid-titlebar').attr('class', 'ui-jqgrid-titlebar ui-jqgrid-caption ui-widget-header ui-corner-top ui-helper-clearfix tl-' + default_bg_color);
            //var tlcolor_first_1 = 'ui-jqgrid-titlebar ui-jqgrid-caption ui-widget-header ui-corner-top ui-helper-clearfix tl-' + default_bg_color;
            //$('.ui-jqgrid-view > .ui-jqgrid-titlebar').attr('class', tlcolor_first_1);

        } else {
            $('.app-sidebar').attr('data-background-color', 'aqua-marine');
            $('.color-customize').attr('data-background-color', 'default');

            localStorage.lc_bg_Color = $('.color-customize').attr('data-background-color', 'default');
            // Oanh edit 23Jan2021
            //localStorage.lc_bg_Menu_Color = $('.app-sidebar').attr('data-background-color', 'aqua-marine');
            localStorage.lc_bg_Menu_Color = 'aqua-marine';
            // End Oanh edit 23Jan2021
            localStorage.lc_bg_Image = $('.app-sidebar').attr('data-image');
            default_bg_color = localStorage.lc_bg_Color;
            default_bg_image = localStorage.lc_bg_Image;
            //$('.app-sidebar').attr('data-background-color', default_bg_color);
            //var tlcolor_first = 'ui-jqgrid-titlebar ui-jqgrid-caption ui-widget-header ui-corner-top ui-helper-clearfix tl-' + default_bg_color;

            //$('.ui-jqgrid-view > .ui-jqgrid-titlebar').attr('class', tlcolor_first);
