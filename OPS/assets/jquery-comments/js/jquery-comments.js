...
(function (factory) {
    ...
    var Comments = {
        ...
        editButtonClicked: function(ev) {
            ...
            //START ADD: HA
            //Modify content of comment
            var time = GetTimeVideoById(FileId, commentModel.id);
            var conte = commentModel.content;
            if (time != "0" ) {
                var newContent = commentModel.content.substring(0, commentModel.content.lastIndexOf('['));
                commentModel.content = newContent;
            }
            //END ADD: HA
            ...
            commentModel.content = conte;  //HA ADD
