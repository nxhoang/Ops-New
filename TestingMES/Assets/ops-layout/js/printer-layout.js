...
function AddCss() {
    ...
    $(".opmt-table, .opsum-btn-close, #opsmodal,#selected-flag,#miniview,.fifth-controls-input-page, .delete-connection,.ops-node-change-page,.connect,.jtk-surface-pan-left, .jtk-surface-pan-right,.jtk-surface-pan-top, .jtk-surface-pan-bottom").addClass("printer-btn");
...
function RemoveCss() {
    ...
    $(".opmt-table, .opsum-btn-close, #opsmodal,#selected-flag,#miniview,.fifth-controls-input-page, .delete-connection,.ops-node-change-page,.connect,.jtk-surface-pan-left, .jtk-surface-pan-right,.jtk-surface-pan-top, .jtk-surface-pan-bottom").removeClass("printer-btn");
    $("#jsPlumb_2_1").find("svg").each(function () {
