...
function GetListOfProductionPackageByAoNoAndFactory(factoryId, startDate, endDate, buyer, styleInfo, aoNo, callBack) {
    var config = ObjectConfigAjaxPost("../Planning/GetListPackageGroupByAoNoFactory", false
        , JSON.stringify({ mesFac: factoryId, startDate: startDate, endDate: endDate, ppFactory: factoryId, aoNo: aoNo, buyer: buyer, styleInfo: styleInfo }));
...
function GetProductionPackage(factoryId, startDate, endDate, buyer, styleInfo, aoNo, callBack) {
    ...
    let listPpByAoFac;
    GetListOfProductionPackageByAoNoAndFactory(factoryId, startDate, endDate, buyer, styleInfo, aoNo, function (listPp) {
        listPpByAoFac = listPp;
    });
    ...
    AjaxPostCommon(config, function (lstPp) {
        ...
        $.each(lstPp, function (index, value) {
            ...
            $.each(listPpByAoFac, function (idx, pp) {
                //D: Done distributed
